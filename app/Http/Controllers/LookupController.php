...
{
    public function __construct(ILookupService $lookupService)
    {
    ...
    public function lookup(LookupRequest $request)
    {
        ...
        return $this->lookupService->getUser($request->input('type'), $identifier_type, $identifier);
    }

//    public function initialCode(Request $request) {
//
//
